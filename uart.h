 ...
 * To enable ISR, callback must be registeren before init.
 * @param [in] baud_rate  USART baud rate, this value will be identical with the baud rate of the COM port
